 ...
 * first a nested for loop to get every possible partitions for a string,
 * then a scanning for all the partitions. That's a O(n^2) for partition and O(n^2) for the scanning of string,
 * totaling at O(n^4) just for the partition.
 * However, if we use a 2d array to keep track of any string we have scanned so far, with an addition pair,
...
public class PalindromePartitioning {
    public static void main(String[] args) {
        String s = "aabaaa";
        PalindromePartitioning tmp = new PalindromePartitioning();
        System.out.println(tmp.partition(s).toString());
    }
